...
namespace RRTest.Controllers
{
    public class GameStartController : MonoBehaviour
    {
        [SerializeField] PlayerDeck playerDeck;
        [SerializeField] GameObject cardPrefab;
        [SerializeField] Transform cardParentTransform;

        public string url = "https://picsum.photos/100/100";
        ...
        IEnumerator Start()
        {
            for (var i = 0; i < 6; i++)
            {
                ...
                else
                {
                    ...
                    var card = Instantiate(cardPrefab, cardParentTransform).GetComponent<CardItemVisualizator>();
